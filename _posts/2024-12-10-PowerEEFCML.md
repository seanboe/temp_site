...
![flyback schematic](assets/images/misc/powereefcml/flyback.png)
![flyback working](assets/images/misc/powereefcml/flybackworking.png)
...
![flyback clamp](assets/images/misc/powereefcml/flybackclamp.png)
...
![PWM Demo](assets/images/misc/powereefcml/PWMDemo.png)

Effect of $n$ levels and $f_{sw}$ on the THD of the output
![THD comparison](assets/images/misc/powereefcml/thd_fc_vs_levels.png)
...
![flyback totem](assets/images/misc/powereefcml/fcml_totem.png)
...
![fcml simple working](assets/images/misc/powereefcml/flybackworking.png)
...
![Discharging](assets/images/misc/powereefcml/flybackworking.png)

FCML at $f_{sw}=142kHz$, $Z_{load}=1k\Omega$:
![150khz](assets/images/misc/powereefcml/150khz.png)
...
![bode](assets/images/misc/powereefcml/bodes.png)
